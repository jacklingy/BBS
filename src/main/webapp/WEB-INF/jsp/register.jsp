...
<div style="width: 500px;height: 600px;margin: 0 auto;">
    ...
    <div class="layui-form-item">
        ...
        <div class="layui-input-inline">
            <input type="text" id="username" name="username"
                   required lay-verify="required" placeholder="请输入用户名" autocomplete="off"
                   class="layui-input">
        </div>
    ...
    <div class="layui-form-item">
        <div class="layui-input-block">
            <button class="layui-btn" lay-submit lay-filter="formDemo" id="submit" onclick="check()">立即提交</button class="layui-btn">
            ...
            $.ajax({
                ...
                success: function (data) {
                    if (data === true) {
                        ...
                        document.getElementById("submit").setAttribute("class", "layui-btn layui-btn-disabled");
                        document.getElementById("submit").setAttribute("disabled", "disabled");

                        // document.getElementById("submit").setAttribute("onclick","function(){" +
                        //     "layer.msg(\"该用户名已经存在，请重新选择！\")}");

                    } else {
                        document.getElementById("confirm3").innerHTML =
                            "<i class=\"layui-icon layui-icon-ok-circle\" style=\"font-size: 30px; " +
                            "color: #39ac47;\"></i>\n";
                        document.getElementById("submit").setAttribute("class", "layui-btn ");
